...
const Page = () => {
    return (
        <div className={`h-[100vh] flex justify-between items-center p-10 relative ${inter.className}`}>
            ...
            <Link href={'/'}>
                <Image src={'/images/Decode_logo.png'} alt={"Logo"} width={60} height={60}
                       className='z-10 absolute top-8 left-8'/>
            </Link>
            <div className='flex flex-col gap-4 justify-center items-center w-[40vw] z-10'>
