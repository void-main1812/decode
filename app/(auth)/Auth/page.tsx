...
const Page = () => {
    ...
    const {calc, handleMouseLeave, handleMouseMove, props, trans} = useDragAnimation();
            ...
            <div className='flex flex-col justify-center h-full items-center w-[35vw] z-10'>
                <div className='flex flex-col justify-start w-full items-start'>
                    ...
                    <TextSection delay={0.5}>
                        <p className='text-lg text-white font-extralight tracking-wider'>Enter Your credentials to
                            access
                            your account</p>
                    </TextSection>
                </div>
